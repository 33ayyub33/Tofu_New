...
var gambar_huruf = [
	"res://img/aset/game_3/CROP/b_2.png",
	"res://img/aset/game_3/u.png",
...
func _ready():
	if Global.music_c.is_playing():
		...
		Global.play_music_c()
	label_soal.text = "BUKU"  # Soal yang ditampilkan
	set_process_input(true)  # Enable input processing
	_show_next_huruf()
	ceklist_button.hide()  # Hide the checklist button initially

# Mengatur input dari pengguna untuk menggambar huruf
func _input(event):
