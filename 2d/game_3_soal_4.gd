...
var gambar_huruf = [
	"res://img/aset/game_3/p.png",
	"res://img/aset/game_3/e.png",
	"res://img/aset/game_3/n.png",
	"res://img/aset/game_3/s.png",
	"res://img/aset/game_3/i.png",
	"res://img/aset/game_3/L.png"
]
...
func _ready():
	if Global.music_c.is_playing():
		...
		Global.play_music_c()
	label_soal.text = "PENSIL"  # Soal yang ditampilkan
