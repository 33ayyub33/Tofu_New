...
var pilihan_jawaban = ["la", "be", "ra", "jar"]
var jawaban_benar = "belajar"  # Jawaban yang benar
...
func _on_ceklis_2_pressed():
	...
	if jawaban_gabungan == jawaban_benar:
		...
		update_sprite("benar")
		get_tree().change_scene_to_file("res://winner_4.tscn")  # Pindah ke scene berikutnya jika benar
	else:
...
func _game_over():
	...
	get_tree().change_scene_to_file("res://game_over_4.tscn")
