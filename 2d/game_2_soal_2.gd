...
var pilihan_jawaban = ["je", "ur", "men", "mur"]
var jawaban_benar = "menjemur"  # Jawaban yang benar
...
func _on_ceklis_2_pressed():
	...
	if jawaban_gabungan == jawaban_benar:
		...
		update_sprite("benar")
		get_tree().change_scene_to_file("res://winner_2_Soal_2.tscn")  # Pindah ke scene berikutnya jika benar
	else:
